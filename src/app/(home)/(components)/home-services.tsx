  ...
  return (
    <Container asChild>
      <Section
        ...
        description='Η Magnus είναι το κορυφαίο γραφείο επαγγελματικής διαχείρισης ακινήτων Airbnb στην Αλεξανδρούπολη. Με εμπειρία άνω των 10 ετών στην βραχυχρόνια μίσθωση, προσφέρουμε ολοκληρωμένες υπηρεσίες γιαι διοκτήτες που θέλουν να αυξήσουν το εισόδημά τους χωρίς άγχος. Με μεγάλο πελατολόγιο ετών και δεκάδες αναθέσεις πολυτελών κατοικιών βραχυχρόνιας μίσθωσης εώς τώρα, η Magnus BnB συνεχίζει δυναμικά να εξασφαλίζει έσοδα για τους πελάτες της καθημερινά, εξυπηρετώντας αμέτρητους ικανοποιημένους επισκέπτες σε όλα της τα καταλύματα. Εμπιστέψου το κατάλυμά σου στη Magnus BnB και συνεργάσου με τους καλύτερους στο χώρο της βραχυχρόνιας μίσθωσης στην Αλεξανδρούπολη.'
      >
          ...
          >
            ...
            <CardBody>
              ...
              <CardDescription>
                ...
                διαφάνεια και προσοχή στη λεπτομέρεια, διασφαλίζοντας κάθε φορά
                άψογη εμπειρία για ιδιοκτήτες και επισκέπτες.
              </CardDescription>
            </CardBody>
          </Card>
          ...
          >
            ...
            <CardBody>
              ...
              <CardDescription>
                ...
                σταθερή ζήτηση και συνεχή κρατήσεις.
              </CardDescription>
            </CardBody>
          </Card>
